...
model = tf.keras.models.load_model('./model_inceptionv3_38.h5')
...
def predict():
    ...
    image = image.resize((256, 256))  # Example: resizing to 150x150 pixels
    ...
    labels = ['scab', 'black rot', 'rust', 'healthy', 'healthy',
           'powdery mildew', 'healthy', 'cercospora leaf gray leaf spot', 'common rust',
           'northern leaf blight', 'healthy', 'black rot', 'black measles', 'leaf blight',
           'healthy', 'huanglongbing', 'bacterial spot', 'healthy',
           'bacterial spot', 'healthy', 'early blight', 'late blight',
           'healthy', 'healthy', 'healthy', 'powdery mildew', 'leaf scorch',
